...
package com.ceci.chess.lib;

import com.ceci.chess.lib.game.GameContext;
import com.ceci.chess.lib.move.Move;
import com.ceci.chess.lib.move.MoveGenerator;
...
public class Board implements Cloneable, BoardEvent {
    ...
    public Board(Board board) {
    	...
    	bitboard = Arrays.copyOf(board.bitboard, board.bitboard.length);
    	bbSide = Arrays.copyOf(board.bbSide, board.bbSide.length);
    	castleRight = new EnumMap<>(board.castleRight);
    	...
    	enableEvents = board.enableEvents;
    	updateHistory = board.updateHistory;
    }
